...
# ╔═╡ 34ac4b0c-33b9-11ed-2e4a-af95e544373f
using PorousMaterials, JLD2, PyPlot, PyCall, CSV, DataFrames, StatsBase, Formatting

# ╔═╡ efa75567-c907-4bcf-9275-72245ffad3f2
md"## loading and merging chemical and structural properties"

# ╔═╡ aa39efb6-38e3-4c05-b99f-05723e77642c
chemical_properties  = CSV.read("descriptors/chemical_properties.csv", DataFrame)

# ╔═╡ a0ec5f0e-7cc7-4377-a6e9-cef983344b8d
geometric_properties = CSV.read("descriptors/geometric_properties.csv", DataFrame)

# ╔═╡ 5a990bf2-6bc2-4550-b335-a93d5d18b165
begin
	descriptors = outerjoin(geometric_properties, chemical_properties, 
		                    on=["crystal_name"]);
	...
	descriptors[!, "xtal"] .= String.(descriptors[:, "xtal"])
	descriptors
end

# ╔═╡ f761ffd7-9b8e-4135-bf42-7a7bb6ff92dd
md"## load simulation data"

# ╔═╡ aad84079-0588-4f7d-82dc-ce4208155cd1
begin
...
# ╔═╡ 224363af-765f-45e4-8af8-7b4d02c8abb1
...
# ╔═╡ 717d9538-3859-45b6-bb93-a811de686cc2
...
# ╔═╡ 618b6577-bbe2-4f62-9b07-1f3c4961255c
begin
	###
	...
	for (i, row) in enumerate(eachrow(df)) 
	    ...
	    for (j, molecule) in enumerate(adsorbates) # [Kr, Xe]
	        ...
	        @load joinpath("data/simulations", henry_filename) results
...
git-tree-sha1 = "23ad0abe01573802849c9c7361eeb55d759aea0d"
...
git-tree-sha1 = "51a6b5558b37310e0016de746bf65ff14d9aee7f"
